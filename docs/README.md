...
| [02_roles.md](./02_roles.md) | Qué puede y qué no puede hacer cada usuario (Maestro, Directora). Credenciales y accesos para pruebas. |
| [03_google_sheets.md](./03_google_sheets.md) | Estructura del Sheet, reglas que no se deben romper, cómo configurar Apps Script. |
| [04_apps_script.md](./04_apps_script.md) | Código completo del Apps Script con instrucciones de publicación. |
...
Directora:         directora  /  director2025
Maestros (todos):  1A ó 1B ó 2A ó 2B … ó 6A ó 6B  /  maestro2025
